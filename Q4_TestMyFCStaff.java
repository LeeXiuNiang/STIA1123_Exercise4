...
class MyFCStaff{
    ...
    public String toString() {
        ...
        nm = String.format(myFormat1,"Staff Name",":",name);
        id = String.format(myFormat1,"Staff ID",":",staffID);
        hrs = String.format("%-15s%-2s%.0f\n","Hours Work",":",totalHoursWork);
        sales = String.format(myFormat2,"Total Sale",": RM ",totalSales);
        salary = String.format(myFormat2,"Total Salary",": RM ",calculateSalary());
